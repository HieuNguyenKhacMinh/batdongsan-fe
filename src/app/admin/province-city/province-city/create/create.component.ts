...
@Component({
    selector: 'create-province-city',
    templateUrl: 'create.component.html',
    styleUrls: ['create.component.scss']
})

export class CreateProvinceCityComponent implements OnInit {
    constructor(
        private service: ProvinceCityService,
        public dialogRef: MatDialogRef<CreateProvinceCityComponent>,
